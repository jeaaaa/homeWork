    ...
    >
      <div class="flex items-center justify-center mt-8">
        <div class="flex items-center">
          <div class="bg-white rounded-full w-12 p-1.5 box-border">
            <img src="../assets/logo.png" />
          </div>

          <span class="mx-2 text-2xl font-semibold text-white">Ostrich</span>
        </div>
      </div>
      ...
      <nav class="mt-10">
        <a
          class="
            ...
            text-gray-500
            hover:bg-gray-600 hover:bg-opacity-25 hover:text-gray-100
          "
          @click="doNav('/#/dashboard')"
        >
          <svg
            class="w-5 h-5"
            viewBox="0 0 20 20"
...
export default defineComponent({
  ...
  methods: {
    doNav(activeRule) {
      history.pushState(null, activeRule, activeRule);
    },
  },
});
</script>
