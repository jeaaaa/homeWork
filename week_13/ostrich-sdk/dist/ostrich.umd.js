(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ostrich = {}));
        ...
        getBrowserInfo: function () {
          ...
          let browerVersionMap = {
            ...
            LBBROWSER: function () {
              ...
              let chrome_vision = navigator.userAgent.replace(/^.*Chrome\/([\d]+).*$/, "$1");
              return hash[chrome_vision] || "";
            },
  ...
  ***************************************************************************** */
  ...
  class Monitor {
    ...
    handleRecordError(params) {
      try {
        ...
        console.log("\n````````````````````` " + params.category + " `````````````````````\n", errorInfo);
        console.log("错误上报>>>：", errorInfo); //记录日志
  ...
  class CaptureClick {
    ...
    reportCaptureImage(options) {
      ...
      const tobeReport = this.capturedDoms.slice(0, this.captureReportNum) || []; // 从cdn上动态插入
...
//# sourceMappingURL=ostrich.umd.js.map
